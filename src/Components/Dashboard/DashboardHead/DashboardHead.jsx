...
function DashboardHead() {
  return (
    <div className="bg-green-900 min-h-screen px-4 sm:px-6 py-6 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        ...
        <div className="bg-green-800 p-5 rounded-2xl shadow-lg text-center sm:text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Weekly Users */}
        <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-xl text-black">
          <h3 className="font-semibold mb-4 text-green-900 text-center sm:text-left">
            Weekly Users
          </h3>
          <div className="w-full h-[220px] sm:h-[250px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={usersData}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="users" fill="#166534" radius={[6, 6, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
